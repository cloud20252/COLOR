...
public class GameController {
    ...
    public ResponseEntity<?> updateChartTrend(@RequestParam Integer wonNumber,@RequestParam Integer wonColor,@RequestParam Integer wonObject) {
        try {
            String message = iGame.updateChartTrend(wonNumber,wonColor,wonObject);
            return ResponseEntity.status(HttpStatus.OK).body(new ResponseDto("success", message));
